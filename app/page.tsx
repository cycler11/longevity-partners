    ...
    <main className="relative min-h-screen w-full overflow-x-hidden">
        ...
        <div className="max-w-3xl">
          <h1 className="mb-6 animate-in fade-in slide-in-from-bottom-8 font-sans text-5xl font-light leading-[1.1] tracking-tight text-foreground duration-1000 md:text-6xl lg:text-7xl">
            <span className="text-balance">
              <span className="inline-block whitespace-nowrap">Find the right</span>{" "}
              ...
              <br />
              <span className="inline-block whitespace-nowrap">products for your goals</span>
            </span>
          </h1>
            ...
            <div className="space-y-8">
                ...
                <div className="space-y-4">
                  ...
                  <div className="rounded-2xl border border-border bg-card/40 p-6 backdrop-blur-md transition-all hover:border-foreground/30 hover:bg-card/60">
                    <div className="mb-3 flex items-center gap-3">
                      ...
                      <div>
                        <h4 className="font-sans text-lg font-semibold text-foreground">Mito Red Light</h4>
                        <p className="font-mono text-xs text-muted-foreground">Photobiomodulation</p>
                      </div>
                    </div>
                    <p className="text-sm leading-relaxed text-foreground/70">
                      Medical-grade red light therapy devices for cellular rejuvenation, recovery, and longevity
                      optimization.
                    </p>
                  </div>
                  ...
                  <div className="rounded-2xl border border-border bg-card/40 p-6 backdrop-blur-md transition-all hover:border-foreground/30 hover:bg-card/60">
                    <div className="mb-3 flex items-center gap-3">
                      ...
                      <div>
                        <h4 className="font-sans text-lg font-semibold text-foreground">Dexcom</h4>
                        <p className="font-mono text-xs text-muted-foreground">Glucose Monitoring</p>
                      </div>
                    </div>
                    <p className="text-sm leading-relaxed text-foreground/70">
                      The most accurate continuous glucose monitoring technology for metabolic health optimization.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="rounded-2xl border border-border bg-card/40 p-6 backdrop-blur-md">
                  <div className="mb-2 font-sans text-3xl font-light text-foreground">15+</div>
                  <div className="font-mono text-xs text-muted-foreground">Curated Products</div>
                </div>
                <div className="rounded-2xl border border-border bg-card/40 p-6 backdrop-blur-md">
                  <div className="mb-2 font-sans text-3xl font-light text-foreground">10K+</div>
                  <div className="font-mono text-xs text-muted-foreground">Happy Customers</div>
                </div>
                <div className="rounded-2xl border border-border bg-card/40 p-6 backdrop-blur-md">
                  <div className="mb-2 font-sans text-3xl font-light text-foreground">7+</div>
                  <div className="font-mono text-xs text-muted-foreground">Partner Brands</div>
                </div>
                <div className="rounded-2xl border border-border bg-card/40 p-6 backdrop-blur-md">
                  <div className="mb-2 font-sans text-3xl font-light text-foreground">4.8★</div>
      ...
      <section className="relative z-10 border-t border-foreground/10 bg-white/60 px-6 py-24 backdrop-blur-md md:px-12">
        <div className="container mx-auto max-w-7xl">
          ...
          <AnimatedGroup className="grid gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4" preset="blur-slide">
